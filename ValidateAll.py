...
def ValidateSam(limit,file,run):
    curr=time.time()
    try:
        check=(subprocess.check_output(["java","-jar","-Xmx40G","/home/ctp21002/Pipeline/picard/build/libs/picard.jar","ValidateSamFile","-I",file,"-MODE","SUMMARY"],stderr=subprocess.DEVNULL))
